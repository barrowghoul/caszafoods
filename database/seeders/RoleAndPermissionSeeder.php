...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $role = Role::create(['name' => 'Compras Admin', 'description' => 'Acceso al módulo de compras'])->givePermissionTo(['ver requisiciones', 'crear requisiciones', 'ver oc', 'crear compras']);
