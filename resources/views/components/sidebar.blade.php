<div class="sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li><a href="{{ route('items.index') }}"><i class="material-icons">view_list</i>{{ __('Items') }}</a></li>
            ...
            @endif
            <li><a href="#"><i class="material-icons">web</i>{{ __('Families') }}</a></li>
            <li><a href="#"><i class="material-icons">dvr</i>{{ __('Units') }}</a></li>
            <li class="nav-heading "> <span>{{ __('Accounts Payable') }}&nbsp;&nbsp;&nbsp;&nbsp;------</span></li>
            @if(auth()->user()->can('ver facturas'))
                <li><a href="{{ route('vendor-invoices.index') }}"><i class="material-icons">receipt</i>{{ __('Invoices') }}</a></li>
            @endif
